...
public class AnimalTrainAdapter  extends RecyclerView.Adapter<AnimalChoiceHolder> {
        ...
        public AnimalTrainAdapter(ArrayList<Animal> animals, ItemClickListener itemClickListener) {
